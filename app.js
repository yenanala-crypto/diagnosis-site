...
const questions = [
  ...
  // 3) 사업관리(팀장/관리) 핵심 (4)
  { id: "13", domain: "사업관리(팀장)", competency: "성과관리 역량", text: "공동훈련센터 성과관리에 필요한 전반적인 대응 전략을 수립하고, 성과를 관리할 수 있다." },
  { id: "14", domain: "사업관리(팀장)", competency: "경영 및 인력현황 분석 역량", text: "학습기업의 사업현황, 인력현황 등을 분석하여 인재육성을 위한 시사점을 찾아낼 수 있다." },
  { id: "15", domain: "사업관리(팀장)", competency: "인사관리 역량", text: "공동훈련센터 목표 달성을 위해 적합한 인력을 채용·배치하고 업무를 부여하며 효율적으로 근무할 수 있도록 지원·관리할 수 있다." },
  { id: "16", domain: "사업관리(팀장)", competency: "인재육성 역량", text: "공동훈련센터 구성원이 지속적으로 성장할 수 있도록 성장욕구를 자극하고 체계적으로 교육훈련을 지원할 수 있다." },
